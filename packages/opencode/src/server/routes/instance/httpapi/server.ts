...
const app = LayerNode.group([
  { ...Npm.node, name: "Npm" },
  { ...FSUtil.node, name: "FSUtil" },
  { ...Database.node, name: "Database" },
  { ...Account.node, name: "Account" },
  { ...Auth.node, name: "Auth" },
  { ...Config.node, name: "Config" },
  { ...Env.node, name: "Env" },
  { ...Ripgrep.node, name: "Ripgrep" },
  { ...Storage.node, name: "Storage" },
  { ...Plugin.node, name: "Plugin" },
  { ...ModelsDev.node, name: "ModelsDev" },
  { ...Provider.node, name: "Provider" },
  { ...ProviderAuth.node, name: "ProviderAuth" },
  { ...Agent.node, name: "Agent" },
  { ...Skill.node, name: "Skill" },
  { ...Discovery.node, name: "Discovery" },
  { ...Question.node, name: "Question" },
  { ...Permission.node, name: "Permission" },
  { ...Todo.node, name: "Todo" },
  { ...Session.node, name: "Session" },
  { ...SessionProjector.node, name: "SessionProjector" },
  { ...SessionStatus.node, name: "SessionStatus" },
  { ...BackgroundJob.node, name: "BackgroundJob" },
  { ...RuntimeFlags.node, name: "RuntimeFlags" },
  { ...EventV2Bridge.node, name: "EventV2Bridge" },
  { ...SessionRunState.node, name: "SessionRunState" },
  { ...SessionProcessor.node, name: "SessionProcessor" },
  { ...SessionCompaction.node, name: "SessionCompaction" },
  { ...SessionRevert.node, name: "SessionRevert" },
  { ...SessionSummary.node, name: "SessionSummary" },
  ...
  { ...InstanceStore.node, name: "InstanceStore" },
  { ...httpClient, name: "httpClient" },
  { ...EventV2.node, name: "EventV2" },
  { ...ProjectV2.node, name: "ProjectV2" },
  { ...ProjectCopy.node, name: "ProjectCopy" },
  { ...PtyTicket.node, name: "PtyTicket" },
])
